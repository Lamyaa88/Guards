...
class SingleNotification extends StatefulWidget {
  SingleNotification(this.userIdToGetNotification, {Key key}) : super(key: key);
  final String userIdToGetNotification;

  @override

  _SingleNotificationState createState() => _SingleNotificationState(userIdToGetNotification);
...
//  }
  ...
  _SingleNotificationState(this.userIdToGetNotificationState );
                            ...
                            InkWell(
                              ...
                              onTap: () {
                                Navigator.of(context).pushReplacement(
                                    MaterialPageRoute(builder: (BuildContext context) => SingleNotification(userIdToGetNotificationState)));
                              },
                                ...
                                Container(width: width*.3,
                                  child: Row(
                                    children: [
                                      ...
                                      Container(
                                        child: myText("date $userIdToGetNotificationState"
//                                            notificationDetails[0]["created_date"]
                                ...
                                Container(margin: EdgeInsets.only(left:0),
                                  ...
                                  child: Column(
                                    children: [Container(
                                      child: myText("title $userIdToGetNotificationState"
//                                          notificationDetails[0]["title"]
                                          , blackColor, width*.03),
                                    ),
                                      Container(child: myText("body $userIdToGetNotificationState"
