...
Future<UserModel> createUser(
    String email, String token, String mobile, String name, String image) async {
...
//  ---------------------------------------------------
  ...
  String userEmailFacebook ;
  String userMobileFacebook ;
//  ----------------------------------------------------
  ...
  Future<UserModel> createUser(
      String email, String token, String mobile, String name, image) async {
    final String apiUrl = "http://n5ba.com/gaurds/the_json/register_socialmedia";
...
//    "job": jobTitle
  ...
  _loginWithFB(BuildContext context) async{
    ...
    if(result.status == FacebookLoginStatus.loggedIn){
      ...
      await _firebaseAuth.signInWithCredential(facebookCredential).then((value) async{
          print('this is value $value');
          setState(() {
            userNameFacebook = value.user.displayName ;
            userEmailFacebook = value.user.email;
            if(value.user.phoneNumber!=null){
              setState(() {
                userMobileFacebook = value.user.phoneNumber;
              }
              );
            }else {
              setState(() {
          ...
          String tokens = await deviceToken;
          setState(() {
            _isLoggedIn = true;
          });
            await createUser(value.user.email, tokens, value.user.phoneNumber,
              ...
              Center(
                  child: _isLoggedIn
                    ...
                    children: <Widget>[
                      ...
                      Text(userNameFacebook),
                      Text(userEmailFacebook),
                      Text(userMobileFacebook),
                        ...
                        children: <Widget>[
                          Center(
                            child: InkWell(onTap: () async {
                              ...
                              print( " user name is : ${userNameFacebook}");
                              print( " user email is : ${userEmailFacebook}");

                              final String email = userEmailFacebook;
                              final String token = deviceToken;
                              final String mobile = "mobile";
                              final String name = userNameFacebook;
                              final String image = "image";
                              final UserModel user =
                              await createUser(email, token, mobile, name, image);
                              //--------------------------------------------------------------------------------- api function
                              setState(() {
                                _user = user;
                              });
...
//                        ==============================================================
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          Center(
                            child: InkWell(onTap: () async {_logout();
    },
                              child: Container(
                                  width: width * .7,
                                  child: Center(
            ...
            child: Center(
              child: InkWell(
                ...
                TextFormField(  keyboardType: type,
                  ...
                  decoration: new InputDecoration(focusColor: redColor,icon:
                  IconButton( icon: Icon(null,color:grayColor
